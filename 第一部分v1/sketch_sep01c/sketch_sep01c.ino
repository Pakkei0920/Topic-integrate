...
//顯示器部分//
    ...
    display.print("esp_pm1.0: "); display.println(esp_pm1);
    display.print("PM2.5: "); display.println(esp_pm25);
    display.print("esp_pm10.0: "); display.println(esp_pm100);
    display.print("Temp1: "); display.print(dht22_temp1);display.println("C");
    display.print("Humd1: "); display.print(dht22_humd1);display.println("%");
    display.print("Temp2: "); display.print(dht22_temp2);display.println("C");
    display.print("Humd2: "); display.print(dht22_humd2);display.println("%");
