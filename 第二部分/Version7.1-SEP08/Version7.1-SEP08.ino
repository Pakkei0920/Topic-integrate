...
#define RGBPIN         26   // 连接到ESP32的NeoPixel数据引脚
#define NUM_PIXELS     60   // NeoPixel的数量
Adafruit_NeoPixel strip = Adafruit_NeoPixel(NUM_PIXELS, RGBPIN, NEO_GRB + NEO_KHZ800);
